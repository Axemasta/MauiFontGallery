...
namespace MauiFontGallery.ComponentModel;

// > TFW No ObservableRangeCollection in .NET in 2024 🤬

/// <summary>
/// Represents a dynamic data collection that provides notifications when items get added, removed, or
